...
![](p8105_hw3_gx2144_files/figure-gfm/unnamed-chunk-8-1.png)<!-- -->
  ...
  - Comment: We can see from this "“spaghetti”plot that the mean of the
...
![](p8105_hw3_gx2144_files/figure-gfm/unnamed-chunk-9-1.png)<!-- -->
  ...
  - Comment:
  - We can see from this two panels that for Bronx county, the data was
    collected only in 2010 and the most response to their overall health
    is “Good”.
