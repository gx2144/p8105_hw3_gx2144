...
ggplot(total,aes(x = day,y = sum))+
  ...
  geom_smooth()
```
**Based on the data, we can see that the sum of the activity count of a day periodically fluctuates.When we look at the smooth of the data, the trend goes like a curve. In the first 14 days, the sum of activity count rises up and in the next 20 days, the sum of activity count goes down. Then, the trend goes up again.
